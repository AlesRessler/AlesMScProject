...
def spherical_deconvolution_fit(fibre_response_function, measurements, qhat, max_degree, number_of_samples_of_fibre_response_function):
    """
    ...
    for i in range(len(measurements)):
        fibre_response_function_partial = partial(fibre_response_function, b_vector=qhat.T[i])
